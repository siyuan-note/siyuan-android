...
//                        Toast.makeText(getApplicationContext(), "No application that can handle this link [" + url + "]", Toast.LENGTH_LONG).show();
    ...
    private void showAgreements() {
        ...
        msg.setText(Html.fromHtml("<div class=\"protyle-wysiwyg protyle-wysiwyg--attr\" style=\"max-width: 800px;margin: 0 auto;\" id=\"preview\"><h1 id=\"隐私政策\">隐私政策</h1>\n" +
                "<ul>\n" +
                "<li id=\"20220211175848-r7vxbtg\">\n" +
                "<p>发布日期：2022 年 2 月 11 日</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-87t2ncl\">\n" +
                ...
                "<p>您提供的个人信息。例如：</p>\n" +
                "<ul>\n" +
                "<li id=\"20220211175848-y2n4tiz\">\n" +
                "<p>您在注册思源笔记云端服务的账号或使用思源笔记云端服务时，向我们提供的个人信息；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-6b2z86n\">\n" +
                "<p>您通过思源笔记云端服务向其他方提供的共享个人信息，以及您使用思源笔记云端服务时所储存的个人信息。</p>\n" +
                "</li>\n" +
                "</ul>\n" +
                "<p>也就是说，如果您不使用思源笔记本云端服务，我们不会收集和获得您的个人信息。</p>\n" +
                ...
                "<p>如果您不再使用思源笔记云端服务，在符合服务协议约定条件及国家相关法律法规规定的情况下，您可以联络我们注销您的账号，届时我们将停止为您提供思源笔记云端服务。（当您的账号注销或被删除后，与该账号相关的思源笔记云端服务项下的全部服务资料和数据将被删除或匿名化处理，但法律法规另有规定的除外。）</p>\n" +
                "<h4 id=\"向您提供服务\">向您提供服务</h4>\n" +
                "<p>我们所收集和使用的个人信息是为您提供思源笔记云端服务的必要条件，如缺少相关个人信息，我们将无法为您提供思源笔记云端服务的核心内容：</p>\n" +
                "<ol>\n" +
                "<li id=\"20220211175848-kex7nec\">\n" +
                ...
                "<ol>\n" +
                "<li id=\"20220211175848-mdrbp20\">\n" +
                "<p>与国家安全、国防安全有关的；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-dnjpt5o\">\n" +
                "<p>与公共安全、公共卫生、重大公共利益有关的；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-8shxqsm\">\n" +
                "<p>与犯罪侦查、起诉、审判和判决执行等有关的；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-u3mfhk3\">\n" +
                "<p>出于维护个人信息主体或其他个人的生命、财产等重大合法权益但又很难得到您本人同意的；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-63qhauj\">\n" +
                "<p>所收集的个人信息是您自行向社会公众公开的；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-qj7tn1e\">\n" +
                "<p>从合法公开披露的信息中收集个人信息的，如合法的新闻报道、政府信息公开等渠道；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-c58em5u\">\n" +
                "<p>根据您的要求签订合同所必需的；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-tv0v8wb\">\n" +
                "<p>用于维护思源笔记云端服务的安全稳定运行所必需的，例如发现、处置产品或服务的故障；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-fhbea7p\">\n" +
                "<p>为合法的新闻报道所必需的；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-9c6y8ny\">\n" +
                "<p>学术研究机构基于公共利益开展统计或学术研究所必要，且对外提供学术研究或描述的结果时，对结果中所包含的个人信息进行去标识化处理的；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-kv39sa2\">\n" +
                "<p>法律法规规定的其他情形。</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-2dcooxg\">\n" +
                ...
                "</li>\n" +
                "<li id=\"20220211175848-xsg2i7m\">\n" +
                "<p>应您合法需求，协助处理您与他人的纠纷或争议；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-rfezb18\">\n" +
                "<p>应您的监护人合法要求而提供您的个人信息；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-qesf042\">\n" +
                "<p>根据与您签署的单项服务协议（包括在线签署的电子协议以及相应的平台规则）或其他的法律文件约定所提供；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-wc3o3rm\">\n" +
                "<p>基于学术研究而提供；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-bj0hxu8\">\n" +
                ...
                "<ol>\n" +
                "<li id=\"20220211175848-5vaq9kt\">\n" +
                "<p>根据您的需求，在您明确同意的披露方式下披露您所指定的个人信息；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-wlfe9rx\">\n" +
                ...
                "<ol>\n" +
                "<li id=\"20220211175848-ifppa6s\">\n" +
                "<p>与国家安全、国防安全有关的；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-o2y8l41\">\n" +
                "<p>与公共安全、公共卫生、重大公共利益有关的；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-fy6m537\">\n" +
                "<p>与犯罪侦查、起诉、审判和判决执行等司法或行政执法有关的；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-1gu2ilz\">\n" +
                "<p>出于维护您或其他个人的生命、财产等重大合法权益但又很难得到本人同意的；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-fa54tv6\">\n" +
                "<p>您自行向社会公众公开的个人信息；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-79dnvl2\">\n" +
                "<p>从合法公开披露的信息中收集个人信息的，如合法的新闻报道、政府信息公开等渠道。</p>\n" +
                "</li>\n" +
                "</ol>\n" +
                ...
                "<ol>\n" +
                "<li id=\"20220211175848-vmv1d1g\">\n" +
                "<p>法律法规有明确规定；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-a95p8xk\">\n" +
                "<p>获得您的授权同意；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-sbtjdt8\">\n" +
                ...
                "<ol>\n" +
                "<li id=\"20220211175848-5sfyh3x\">\n" +
                "<p>如果我们处理个人信息的行为违反法律法规；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-3tch12q\">\n" +
                "<p>如果我们收集、使用您的个人信息，却未征得您的授权同意；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-dpxwavv\">\n" +
                "<p>如果我们处理个人信息的行为严重违反了与您的约定；</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-1q5m3ub\">\n" +
                ...
                "<p>如您需要注销账户，请登录思源网页端，进入「设置」-「账号详情」自行删除账户。</p>\n" +
                ...
                "<p>SDK 官网：<a href=\"https://open.weixin.qq.com/\">https://open.weixin.qq.com <strong>(opens new window)</strong></a></p>\n" +
                ...
                "<p><strong>Android 应用会申请的权限</strong></p>\n" +
                "<ul>\n" +
                "<li id=\"20220211175848-q0mihfb\">\n" +
                "<p><strong>允许拍照/访问相册：</strong>当您希望添加照片时，我们会申请此权限。</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-06y5c39\">\n" +
                "<p><strong>允许写入外部储存空间：</strong>当您将图片附件保存到手机时，我们会申请此权限。获得授权后，您可以将图片附件下载到手机本地。</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-kid06te\">\n" +
                "<p><strong>允许读取外部储存空间：</strong>当您在任务中上传附件时，我们会申请此权限。</p>\n" +
                "</li>\n" +
                "</ul>\n" +
                "<p><strong>iOS 应用内会申请的权限</strong></p>\n" +
                "<ul>\n" +
                "<li id=\"20220211175848-q5d2sup\">\n" +
                "<p><strong>允许访问系统相册：</strong>当您从相册上传图片附件时，我们会申请此权限。</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-gfq20pt\">\n" +
                "<p><strong>允许写入系统相册：</strong>当您将图片附件保存到手机本地时，我们会申请此权限。</p>\n" +
                "</li>\n" +
                "<li id=\"20220211175848-n0geoj3\">\n" +
                "<p><strong>允许使用麦克风录音：</strong> 当您在任务中添加录音附件、或使用语音输入添加任务时，我们会申请此权限。</p>\n" +
                "</li>\n" +
                "</ul>\n" +
