...
//                    }
    ...
    private void showAgreements() {
        ...
        msg.setText(Html.fromHtml("<div class=\"protyle-wysiwyg protyle-wysiwyg--attr\" style=\"max-width: 800px;margin: 0 auto;\" id=\"preview\"><h1 id=\"隐私政策\">隐私政策</h1>\n" +
                ...
                "<p>同时，依照相关法律法规的要求或者特定功能及服务需要，您在使用特定功能及服务前，可能需要您提供其他个人信息（例如姓名、身份证、面部特征及其他身份证明信息）。如果您不提供上述个人信息，我们将不能向您提供相关的功能及服务。</p>\n" +
                ...
                "</li>\n" +
                "</ol>\n" +
                "<p>为进行用户画像、了解产品适配性、识别账号异常状态，我们可能会收集关于您使用的服务以及使用方式的个人信息并将这些个人信息进行关联，这些个人信息包括：</p>\n" +
                "<ol>\n" +
                ...
                "<p>基于上述您向我们提供的个人信息、我们可能收集的个人信息及我们通过间接方式收集到的您的个人信息，我们可能会基于上述一项或几项个人信息的结合，进行用户行为分析及用户画像，以便了解产品适配性、识别账号异常状态。</p>\n" +
                "</li>\n" +
